...
var Engine = exports.Engine = function Engine(options) {
  ...
  this._reporter = 'spec';
  if(environment.config.reporter !== undefined && environment.config.reporter !== null && environment.config.reporter !== "")
    this._reporter = environment.config.reporter;
  if(options.reporter !== undefined && options.reporter !== null && options.reporter !== "")
    this._reporter = options.reporter;
  Reporter = require('mocha/lib/reporters/' + this._reporter);
};
